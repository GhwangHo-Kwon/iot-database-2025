...
## 1일차
- 데이터베이스 시스템
    - 통합된 데이터를 저장후 운영하면서, 동시에 여러사람이 사용할 수 있도록 하는 시스템
...
- MySQL 설치 (Docker)
    ...
    5. 컨테이너 확인
        ...
        CONTAINER ID   IMAGE          COMMAND                   CREATED              STATUS              PORTS
             NAMES
        aeee7ca3a67f   mysql:latest   "docker-entrypoint.s…"   About a minute ago   Up About a minute   0.0.0.0:3306->3306/tcp, 33060/tcp   mysql-container
        ```
...
- 데이터베이스 연동 프로그래밍
    - PyMySQL 모듈사용
    - 파이썬 DB연동 콘솔 : [주피터노트북](./day05/db05_파이썬_DB연동.ipynb)
...
## 6일차
- 데이터모델링 계속 : [SQL](./day06/db02_마당대학_스키마.sql)
...
- 트랜잭션 : [SQL](./day06/db04_트랜잭션.sql)
    ...
    - 특징
        ...
        - D(지속성) - Durability, 트랜잭션 후에 저장된 데이터는 무한이 값이 유지되어야 함.
...
- Workbench Tip
    ...
    - 메뉴 `Edit > Preferences > SQL Editor > SQL Excution에서 Limit Rows Count`를 조절
